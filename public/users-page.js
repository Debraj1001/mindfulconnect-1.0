  ...
  async function loadUsers() {
    ...
    `
      ...
      const {
        ...
        .order("last_seen", { ascending: false }) // Then by most recently seen
        .range(from, to)
      ...
      // Render users
      users.forEach((user) => {
        // Skip current user if they exist in the results
        ...
        <div class="user-card-header">
          ...
          <div class="user-info">
            ...
            <p class="last-seen"><i class="fas fa-clock"></i> ${lastSeenText}</p>
          </div>
        </div>
        <div class="user-bio">
          <p>${truncatedBio}</p>
